...
public interface MoxyEngine {
  /**
   * Constant representing all methods; For use with mock(...) and getMockClass(...).
   */
  public static final Set<Method> ALL_METHODS = Collections.emptySet();
  ...
  /**
   * <p>Create a mock of the given class, mocking only the given methods
   * (plus any that are abstract or must otherwise be mocked). Any remaining
   * methods will retain their superclass implementation.</p>
   * 
   * <p>The mock will be created in the engine's default <code>ClassLoader</code>. 
   * For the default engine, this is the same <code>ClassLoader</code> that
   * loaded the engine.</p>
   * 
   * @param clz The <code>Class</code> to mock.
   * @param methods The methods to mock.
   *  
   * @return A new mock instance.
   * 
   * @param <T> The type being mocked.
